...
import { login, passwordReset, updateAccountPassword,checkUserPassword,sendResetPasswordEmailToken, resetPasswordTokenVerify, passwordResetWithToken,changeUserEmail } from '../controllers/auth/authentication.js'
...
router
.post('/login',login)
.post('/change/password/v/1.0',updateAccountPassword)
