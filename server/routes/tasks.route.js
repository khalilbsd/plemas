...
import { associateIntervenantToTask, createTask, getDailyTasks, getProjectTasks, updateIntervenantHours,getTaskPotentialIntervenants } from "../controllers/tasks/task.controller.js";
...
.patch('/project/:projectID/potential/task/intervenants/list',isUserAuthenticated,checkUserRole([SUPERUSER_ROLE,PROJECT_MANAGER_ROLE]),getTaskPotentialIntervenants)
